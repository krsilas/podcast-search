<script>
    ...
    async function PodcastAPI() {
        return fetch(`/proxy/api/v1/de/podcasts/top-podcasts/all/10/non-explicit.json`)
            .then(res=>res.json())
