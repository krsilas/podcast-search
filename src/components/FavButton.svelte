...
<button on:click={handleClick} class="px-3 py-2 bg-orange-300 active:bg-orange-400 desaturate-75 flex rounded-lg">
    ...
    <span class="text-orange-900 leading-snug w-24 text-left font-bold mx-2">{isFav ? 'Favorisiert' : 'Favorisieren'}</span>
</button>